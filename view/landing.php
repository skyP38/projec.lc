    <?php
      ...
      require_once __DIR__ . DSE . 'default' . DSE . 'nav_home.php';
    ...
    <header class="header">
      <div class="content_wrapper">
        ...
        <h2>
          Сервис для хранения паролей и персональных данных, пользователей
          основанный на алгоритме случайной выборки RMX (Random Matrix Expression).
        </h2>
        <img id="rmx" src="/dist/i/rmx.png" alt="">
        <a href="/login">
